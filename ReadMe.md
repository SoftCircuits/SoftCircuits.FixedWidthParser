...
SoftCircuits.FixedWidthParser is a lightweight .NET class for reading and writing fixed-width data files. Included basic reader and writer class, and also includes generic class that automatically map class properties to fixed-width fields. Many options included.
